...
TOKEN = Path('~/.figshare/token').expanduser().read_text().strip()
CHUNK_SIZE = 10485760 #about 10MB
FILE_PATH = '/gws/nopw/j04/mcs_prime/mmuetz/data/UM_sims/u-dg135/processed/stochMCSP/engla_pa.precip.nc' #If the file is in the same folder as this notebook, put the name of the file in quotes. E.g. 'file-name.mp4'
