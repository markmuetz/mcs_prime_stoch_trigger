...
slurm_config = {'account': 'mcs_prime', 'partition': 'standard', 'qos': 'standard', 'mem': 64000, 'time': '20:00:00'}
...
@rule(
    matrix={'month': list(range(1, 13)), 'variable': ['geopotential']},
    outputs={
        'output': str(
    ...
    uses={'req_var_names': req_var_names},
)
def era5_download_geopotential(outputs, month, variable):
    client = cdsapi.Client()
